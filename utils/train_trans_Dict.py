...
optimizer = Optimizer.from_params([x for x in model.named_parameters() if x[1].requires_grad and x[0] != 'Dict'] ,
                                  params['trainer']['optimizer'])#在default里面，用Adam优化，


optimizer_mem = Optimizer.from_params([x for x in model.named_parameters() if x[1].requires_grad and x[0] == 'Dict'] ,
