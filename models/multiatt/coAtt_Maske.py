...
#################################################################################################################################
    ...
    def forward(self,
        ...
        qa_rep = self.QAGA_transformer(attended_o.view(attended_o.size(0)*attended_o.size(1),attended_o.size(2),attended_o.size(3)),attended_q.view(attended_q.size(0)*attended_q.size(1),attended_q.size(2),attended_q.size(3)),None,None) #[b x 4, q_len, 512]
        ...
        aq_rep = self.QAGA_transformer(attended_q.view(attended_q.size(0)*attended_q.size(1),attended_q.size(2),attended_q.size(3)),attended_o.view(attended_o.size(0)*attended_o.size(1),attended_o.size(2),attended_o.size(3)),None,None) #[b x 4, q_len, 512]
