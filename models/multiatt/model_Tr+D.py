...
################################################################################################################################
        path = '/home/tangxueq/MA_tang/r2c/models/saves/memory_cell1.npz'
...
############################################################################################################################
        ...
        self.lstm_norm = torch.nn.BatchNorm1d(800)
        ...
        #[96,4,50,1024]
        dim = 256#768*2 #sum([d for d, to_pool in [(reasoning_encoder.get_output_dim(), self.pool_reasoning),
    ...
    def memory_cell_load(self,path):
        if os.path.isfile(path):
            ...
            memory_init = torch.rand(800, 512)/100
...
##################################################################################################################
    ...
    #########################################################
        output_res = output_res.view(-1,4,256)
