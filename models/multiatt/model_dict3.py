...
############################################################################################################################
        ...
        #[96,4,50,1024]
        dim = 4*512#768*2 #sum([d for d, to_pool in [(reasoning_encoder.get_output_dim(), self.pool_reasoning),
    ...
    def memory_cell_load(self,path):
        if os.path.isfile(path):
            ...
            memory_init = torch.rand(200, 1024)/100
...
#######################################################################################################
        ...
        qa_feature ,(h_n, h_c)= self.lstm(transformer)
...
##############################################################################################################
        # '''这一段是 DICT'''
        #
        # att = qa_feature @ self.memory_cell.T
        #
...
#########################################################
        output_res = qa_feature.view(-1,4,512)
